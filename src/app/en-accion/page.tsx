...
const campanas: Campana[] = [
  ...
  },
  {
    ...
    subtitulo: "Campaña de Navidad 2025",
    ...
    resumen:
      "ToTemRoBot se vistió de Navidad para recorrer los centros comerciales más concurridos de Madrid durante las fechas más especiales del año, llevando el espíritu festivo directamente al público.",
    descripcionLarga:
      "Con decoración navideña personalizada y una selección de aromas y sonidos festivos, ToTemRoBot se convirtió en el centro de atención durante la campaña de Navidad. Durante 3 semanas, el robot sorprendió a compradores y familias en 8 locales de la capital, generando momentos memorables y una alta interacción orgánica en redes sociales.",
    metricas: [
      { num: "8", label: "Locales" },
      { num: "3", label: "Semanas" },
      { num: "🎄", label: "Navidad" },
  ...
  },
  {
    ...
    subtitulo: "Campaña de Halloween 2025",
    fecha: "Octubre 2025",
    ...
    resumen:
      "Una campaña que combinó el miedo escénico con la tecnología. ToTemRoBot transformó su presencia para asustar —en el buen sentido— a miles de visitantes durante Halloween.",
    descripcionLarga:
      "Decorado con elementos de terror y emitiendo efectos sonoros inquietantes combinados con aromas especiales, ToTemRoBot protagonizó una de las activaciones de Halloween más originales de 2025. La campaña generó largas colas de visitantes queriendo fotografiarse con el robot y una gran difusión espontánea en redes sociales.",
    metricas: [
