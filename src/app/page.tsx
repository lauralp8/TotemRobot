      ...
      <div style={{ background: "#ffffff" }}>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden group shadow-[0_8px_40px_rgba(0,0,0,0.10)]">
              <img
                src="/images/EscaparateMadrid.png"
                alt="TotemRobot en escaparate de Madrid"
        ...
        <div className="animate-marquee">
          {[
            ...
            <span key={i} className="inline-flex items-center gap-8 px-8 text-base font-black tracking-[0.18em] uppercase text-white whitespace-nowrap">
              {item} <span style={{color: "#efc650"}}>✦</span>
            </span>
          ))}
        </div>
      </div>
            ...
            <div className="relative text-center max-w-2xl mx-auto px-4">
              ...
              >
                ...
                <span
                  ...
                  style={{
                    background: "linear-gradient(90deg, #c9a227 0%, #efc650 35%, #ffe99a 55%, #efc650 75%, #c9a227 100%)",
              ...
              <div className="mt-5 flex justify-center">
                <div
                  style={{
                    height: "1px",
                    width: "5rem",
                    background: "linear-gradient(90deg, transparent, #efc650, transparent)",
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-16 lg:gap-24 items-start">
            ...
            <div>
              ...
              <div className="w-10 h-px mb-7" style={{ background: "linear-gradient(90deg, #efc650, transparent)" }} />
